...
#include "glfw_exports_generated.h"
	...
	std::string getTypeDefinitions() {
		...
		std::string aliasedTypes(reinterpret_cast<char*>(Runtime_Bindings_glfw_aliases_h), Runtime_Bindings_glfw_aliases_h_len);
		std::string exportedTypes(reinterpret_cast<char*>(Runtime_Bindings_glfw_exports_h), Runtime_Bindings_glfw_exports_h_len);
