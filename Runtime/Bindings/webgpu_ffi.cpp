...
namespace webgpu_ffi {
	...
	void* getExportsTable() {
		...
		webgpu_exports_table.wgpu_command_buffer_set_label = wgpuCommandBufferSetLabel;
		...
		webgpu_exports_table.wgpu_device_set_device_lost_callback = wgpuDeviceSetDeviceLostCallback;
