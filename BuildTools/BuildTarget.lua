...
function BuildTarget:SetLuaBytecodeGenerator()
	...
	ninjaFile:AddRule("embed", "xxd -i $in $out", {
...
function BuildTarget:ProcessNativeSources()
	...
	for index, cppSourceFilePath in ipairs(self.cppSources) do
		...
		local autoGeneratedDependencies = self.autoGeneratedHeaders[cppSourceFilePath]
		...
		for dependent, autoGenerationInfo in pairs(autoGeneratedDependencies) do -- buildEdge
			for outputFileName, inputFilePath in pairs(autoGenerationInfo) do
				table.insert(dependencies, inputFilePath)
			end
		end
...
function BuildTarget:ProcessBinaryEmbeds()
	...
	for dependent, autoGenerationInfo in pairs(self.autoGeneratedHeaders) do
		...
		for outputFileName, inputFilePath in pairs(autoGenerationInfo) do
			...
			ninjaFile:AddBuildEdge(outputFilePath, "embed " .. inputFilePath, {
				generated = "1",
			})
