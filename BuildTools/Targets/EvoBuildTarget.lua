...
local EvoBuildTarget = {
	...
	autoGeneratedHeaders = { -- binaryEmbeds
		["Runtime/Bindings/crypto_exports.h"] = "crypto_exports_generated.h",
		["Runtime/Bindings/glfw_aliases.h"] = NinjaBuildTools.DEFAULT_BUILD_DIRECTORY_NAME .. "/glfw_aliases_generated.h",
	},
	includeDirectories = {
