...
cmake -S $SRC_DIR -B $BUILD_DIR -G Ninja -DLWS_WITH_SHARED=OFF -DLWS_WITH_MINIMAL_EXAMPLES=OFF -DLWS_WITH_SYS_SMD=OFF -DLWS_WITH_SSL=OFF -DLWS_WITH_LIBUV=ON -DCMAKE_C_COMPILER=gcc
