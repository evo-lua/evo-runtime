...
cmake -S $SRC_DIR -B $BUILD_DIR -G Ninja -DLUA_INCLUDE_DIR=$LUAJIT_SOURCE_DIR  -DLUA_LIBRARIES=$LUA_LIBRARIES -DRAPIDJSON_INCLUDE_DIRS=$RAPIDJSON_INCLUDE_DIRS -DCMAKE_C_COMPILER=gcc -DCMAKE_POLICY_VERSION_MINIMUM=3.5
