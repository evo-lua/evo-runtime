...
cmake -S $SRC_DIR -B $BUILD_DIR -G Ninja $FEATURE_FLAGS -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ $LIBRARY_INCLUDES -DCMAKE_BUILD_TYPE=Release -DCMAKE_OSX_ARCHITECTURES=$(uname -m)
cmake --build $BUILD_DIR --clean-first
