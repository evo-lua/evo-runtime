...
describe("labsound", function()
	...
	describe("bindings", function()
		...
		describe("labsound_context_load_hrtf_database", function()
			it("should return false if nullptr values are passed", function()
				assertFalse(labsound.bindings.labsound_context_load_hrtf_database(nil, "valid-path"))
				assertFalse(labsound.bindings.labsound_context_load_hrtf_database(nil, nil))
			end)
		end)

		describe("labsound_context_listener_set_forward", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_context_listener_set_forward(nil, 0, 0, 1)
			end)
		end)

		describe("labsound_context_listener_set_up_vector", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_context_listener_set_up_vector(nil, 0, 1, 0)
			end)
		end)

		describe("labsound_context_listener_set_position", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_context_listener_set_position(nil, 0, 0, 0)
			end)
		end)

		describe("labsound_context_listener_set_velocity", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_context_listener_set_velocity(nil, 0, 0, 0)
			end)
		end)

		describe("labsound_context_synchronize_connections", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_context_synchronize_connections(nil)
			end)
		end)
		...
		describe("labsound_panner_node_create", function()
			it("should return nullptr if nullptr values are passed", function()
				assert(labsound.bindings.labsound_panner_node_create(nil) == ffi.NULL)
			end)
		end)

		describe("labsound_panner_node_destroy", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_destroy(nil)
			end)
		end)

		describe("labsound_panner_node_set_orientation", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_orientation(nil, 0, 0, 0)
			end)
		end)

		describe("labsound_panner_node_set_position", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_position(nil, 0, 0, 0)
			end)
		end)

		describe("labsound_panner_node_set_velocity", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_velocity(nil, 0, 0, 0)
			end)
		end)

		describe("labsound_panner_node_set_panning_model", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_panning_model(nil, ffi.C.LabSoundPanningModel_HRTF)
			end)
		end)

		describe("labsound_panner_node_set_distance_model", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_distance_model(nil, ffi.C.LabSoundDistanceModel_Linear)
			end)
		end)

		describe("labsound_panner_node_set_ref_distance", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_ref_distance(nil, 1)
			end)
		end)

		describe("labsound_panner_node_set_max_distance", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_max_distance(nil, 100)
			end)
		end)

		describe("labsound_panner_node_set_rolloff_factor", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_rolloff_factor(nil, 1)
			end)
		end)

		describe("labsound_panner_node_set_cone_inner_angle", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_cone_inner_angle(nil, 60)
			end)
		end)

		describe("labsound_panner_node_set_cone_outer_angle", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_cone_outer_angle(nil, 90)
			end)
		end)

		describe("labsound_panner_node_set_cone_outer_gain", function()
			it("should not crash if nullptr values were passed", function()
				labsound.bindings.labsound_panner_node_set_cone_outer_gain(nil, 0.5)
			end)
		end)
