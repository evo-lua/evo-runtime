...
describe("iconv", function()
	describe("bindings", function()
		describe("iconv_convert", function()
			...
			it("should be able to convert Windows encodings to UTF-8", function()
				...
				assertEquals(tonumber(result.status_code), ffi.C.CHARSET_CONVERSION_SUCCESS)
				assertEquals(ffi.string(result.message), ffi_strerror(ffi.C.CHARSET_CONVERSION_SUCCESS))
	...
	describe("convert", function()
		it("should be able to convert Windows encodings to UTF-8", function()
			...
			assertEquals(message, ffi_strerror(ffi.C.CHARSET_CONVERSION_SUCCESS))
		end)
